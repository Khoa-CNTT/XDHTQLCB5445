...
const ServiceDetailPage = () => {
    ...
    const fetchServiceAndReviews = async () => {
      try {
        ...
        if (reviewData.success) {
          ...
          const totalStars = reviewData.data.reduce(
            (sum, r) => sum + r.rating,
            0
          );
  ...
  const handleBookNow = () => {
    ...
    if (role !== "user") {
      errorToast("Chỉ người dùng mới đặt lịch được!");
      setTimeout(() => {
        navigate("/");
      }, 2000);
      return;
          ...
          <div className="md:w-2/3">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                {service.description ||
                  "Thư giãn và phục hồi cơ thể với liệu pháp massage truyền thống của chúng tôi."}
              </p>
            </div>
            <div className="mt-8">
              <ReviewsDeTailDV />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md sticky top-24">
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <p className="text-gray-600">
                  <span className="font-semibold">Lưu ý:</span> Vui lòng đến
                  trước 15 phút để hoàn thành thủ tục đăng ký và chuẩn bị trước
                  buổi trị liệu của bạn.
                </p>
              </div>
            </div>
          </div>
